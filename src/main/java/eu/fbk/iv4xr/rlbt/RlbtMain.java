...
public class RlbtMain{
	...
	static int numOfEpisodes =1; //0;				/*number of episodes for Q-learning training*/
	
	
	private static void labRecruitsExample() throws InterruptedException {
		LabRecruitsRLEnvironment labRecruitsRlEnvironment = new LabRecruitsRLEnvironment(maxUpdateCycles, level);
